...
pub fn new_map_rooms_and_corridors() -> Map {
    let mut map = Map {
        tiles: vec![TileType::Wall; (COLUMNS_MAX * ROWS_MAX) as usize],
        rooms: Vec::new(),
        width: COLUMNS_MAX,
        height: ROWS_MAX,
        revealed_tiles: vec![false; (COLUMNS_MAX * ROWS_MAX) as usize],
        visible_tiles: vec![false; (COLUMNS_MAX * ROWS_MAX) as usize],
    };
