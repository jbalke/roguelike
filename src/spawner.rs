...
pub fn spawn_room(ecs: &mut World, room: &Rect, map_depth: i32) {
    ...
    let mut spawn_points: HashMap<usize, &str> = HashMap::new();
    ...
    for (index, &item) in spawn_points.iter() {
        let x = (*index % MAPWIDTH) as i32;
        let y = (*index / MAPWIDTH) as i32;
